...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://raw.githubusercontent.com/Piyush/Piyush/main/image%2011.png",
        width: 1200,
        height: 630,
        alt: "Piyush",
      },
  ...
  twitter: {
    ...
    title: "Piyush",
    description:
      "Innovative Young Technologist working on projects, currently working at magnimont. Focused on interfaces and experiences, working remotely from Telengana, India.",
    creator: "Piyush",
    creatorId: "1243720976552144897",
    images: [
      "https://raw.githubusercontent.com/Piyush/Piyush/main/image%2011.png",
    ],
  },
  robots: {
    index: true,
