      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            ...
            <Link
              ...
              aria-label="Chatting website"
            >
              duocord,
            </Link> currently not available for work.
          </p>
        </motion.div>
        ...
        >
          <p className="text-right text-[16px] font-semibold text-[#e4ded7] md:text-[20px]">
            Focused on interfaces and experiences, working remotely from Hydrabad,
            India.
          </p>
        </motion.div>
      </div>
